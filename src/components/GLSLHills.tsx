...
/**
 * Animated GLSL hills / noise terrain. Browser-only — must be dynamically
 * imported behind <ClientOnly> so it never runs during SSR.
 */
export default function GLSLHills({
  ...
  useEffect(() => {
    ...
    const material = new THREE.RawShaderMaterial({
      ...
      fragmentShader: /* glsl */ `
        ...
        void main(void) {
          ...
          // Warm amber tint to match Obsidian palette
          vec3 color = vec3(0.96, 0.63, 0.14);
    ...
    const camera = new THREE.PerspectiveCamera(45, iw / ih, 1, 10000);
