  ...
  head: () => ({
    meta: [
      { title: "Obsidian — Make Your Ideas Impossible To Ignore." },
      {
        name: "description",
        content:
          "Obsidian removes the translation tax between idea, design, code, and refinement. The result is less tool friction, fewer broken handoffs, and more potential.",
      },
