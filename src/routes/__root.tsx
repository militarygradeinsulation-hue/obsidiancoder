...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A creative force multiplier turning intent into production-grade software via system intuition. Code with clarity. Ship with force." },
      { name: "twitter:description", content: "A creative force multiplier turning intent into production-grade software via system intuition. Code with clarity. Ship with force." },
