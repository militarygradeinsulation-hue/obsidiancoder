...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Transcending the surface-level patterns of mainstream AI" },
      { property: "og:description", content: "Obsidian is a creative force multiplier turning intent into production-grade software via system intuition. Code with clarity. Ship with force." },
      { name: "twitter:description", content: "Obsidian is a creative force multiplier turning intent into production-grade software via system intuition. Code with clarity. Ship with force." },
